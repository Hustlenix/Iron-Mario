...
func setup_game() -> void:
	...
	var socket_positions := [Vector2(925, 260), Vector2(1040, 415), Vector2(900, 560)]
...
func _draw_piece(pos: Vector2, shape: int, color: Color, socket: bool) -> void:
	...
	if shape == 0:
		Paint.rect(self, Rect2(pos - Vector2(31, 31), Vector2(62, 62)), color)
		Paint.rect(self, Rect2(pos - Vector2(31, 31), Vector2(62, 62)), outline, false, 5.0)
	elif shape == 1:
		Paint.circle(self, pos, 33, color)
		Paint.circle(self, pos, 33, outline, false, 5.0)
	else:
		var points := PackedVector2Array([pos + Vector2(0, -39), pos + Vector2(39, 0), pos + Vector2(0, 39), pos + Vector2(-39, 0)])
		Paint.polygon(self, points, PackedColorArray([color]))
		Paint.polyline(self, PackedVector2Array([points[0], points[1], points[2], points[3], points[0]]), outline, 5.0)
	if not socket:
		Paint.line(self, pos + Vector2(-12, 0), pos + Vector2(12, 0), Color("ffffff"), 4.0)
		Paint.line(self, pos + Vector2(0, -12), pos + Vector2(0, 12), Color("ffffff"), 4.0)

func _draw_armor_outline() -> void:
	Paint.circle(self, Vector2(935, 260), 92, Color("e34838"))
	Paint.rect(self, Rect2(815, 335, 240, 250), Color("e34838"))
	Paint.rect(self, Rect2(750, 355, 65, 210), Color("ffd13c"))
	Paint.rect(self, Rect2(1055, 355, 65, 210), Color("ffd13c"))
	Paint.rect(self, Rect2(835, 585, 85, 62), Color("ffd13c"))
	Paint.rect(self, Rect2(950, 585, 85, 62), Color("ffd13c"))
